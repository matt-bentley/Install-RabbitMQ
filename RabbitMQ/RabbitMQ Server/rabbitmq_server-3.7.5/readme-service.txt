   ...
   rabbitmq-service.bat — manage RabbitMQ AMQP Windows service
   ...
   service can be started and stopped using the Windows® services applet.
   ...
   the account that will be used to run rabbitmqctl(8).
   ...
   remove
           ...
           deleted as a consequence and rabbitmq-server(8) will remain
           operable.
   ...
   RABBITMQ_BASE
           ...
           the current user. This is the location of log and database
           directories.
